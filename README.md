...
کد دعوت خام فقط همان زمان ساخت در پنل admin نمایش داده و قابل کپی است؛ دیتابیس صرفاً هش آن را نگه می‌دارد. بنابراین کدهای قبلی قابل بازیابی یا کپی نیستند. کدهای استفاده‌نشده را می‌توان حذف دائمی کرد؛ کدهای مصرف‌شده برای حفظ audit trail فقط غیرفعال می‌شوند.
